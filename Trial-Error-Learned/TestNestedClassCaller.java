/* Source code listing of the TestNestedClass.java:
 *
...
public class TestNestedClassCaller
{
	public static void main(String[] args)
	{
		TestNestedClass tax = new TestNestedClass();
		tax.setTaxDetailInfo();
		System.out.println("tax.getTaxDetailInfo(0).netIncomePortion(); //" + tax.getTaxDetailInfo(0).netIncomePortion());
		// Below codes will causing the compiler complaints because the 'level' field is defined private.
		// Prefect! :)
		//tax.getTaxDetailInfo(0).level = 3;
		//System.out.println(tax.getTaxDetailInfo(0).level);
	}
}
